...
public class JamiesModStructures
{
    ...
    public static StructurePieceType ANCIENT_ROOTS_PIECES = Registry.register(BuiltInRegistries.STRUCTURE_PIECE,
            Bygone.getModId("ancient_roots"),  AncientRootGenerator.Piece::new);
