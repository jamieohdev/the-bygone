...
public class JamiesModDataComponentTypes
{
  ...
  //  public static final ComponentMap DEFAULT_ITEM_COMPONENTS;
    ...
    private static <T> DataComponentType<T> register(String id, UnaryOperator<DataComponentType.Builder<T>> builderOperator) {
        ...
        return (DataComponentType)Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE, Bygone.getModId(id), ((DataComponentType.Builder)builderOperator.apply(DataComponentType.builder())).build());
    }
