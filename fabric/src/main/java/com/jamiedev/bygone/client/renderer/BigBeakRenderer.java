...
import com.jamiedev.bygone.common.entities.BigBeakEntity;

public class BigBeakRenderer  extends MobRenderer<BigBeakEntity, BigBeakModel<BigBeakEntity>> {
    private static final ResourceLocation TEXTURE = Bygone.getModId("textures/entity/big_beak.png");
    HorseRenderer ref;
    ...
    public BigBeakRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new SaddleLayer<>(this, new BigBeakModel<>(context.bakeLayer(JamiesModModelLayers.BIG_BEAK_SADDLE)), Bygone.getModId("textures/entity/big_beak_saddled.png")));
