...
import com.jamiedev.bygone.common.entities.CoelacanthEntity;

public class CoelacanthRenderer extends MobRenderer<CoelacanthEntity, CoelacanthModel<CoelacanthEntity>> {
    private static final ResourceLocation TEXTURE = Bygone.getModId("textures/entity/coelacanth.png");
SalmonRenderer ref;
