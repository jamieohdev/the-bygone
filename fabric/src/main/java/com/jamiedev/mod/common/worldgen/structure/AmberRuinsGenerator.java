...
{
    private static final ResourceLocation[] FOSSILS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "amber_ruins_1"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "amber_ruins_2"),
            ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "amber_ruins_3"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "amber_ruins_4"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "amber_ruins_5")};
    ...
    public static void addPieces(StructureTemplateManager manager, StructurePieceAccessor holder, RandomSource random, BlockPos pos) {
        ...
        holder.addPiece(new AmberRuinsGenerator.Piece(manager, (ResourceLocation) Util.getRandom(FOSSILS, random), pos, blockRotation));
    }
