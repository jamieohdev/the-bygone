...
{
    private static final ResourceLocation[] FOSSILS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "ancient_roots_1"),
            ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "ancient_roots_2"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID,"ancient_roots_3"),
            ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID,"ancient_roots_4"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID,"ancient_roots_5"),
            ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID,"ancient_roots_6")};
    ...
    public static void addPieces(StructureTemplateManager manager, StructurePieceAccessor holder, RandomSource random, BlockPos pos) {
        ...
        holder.addPiece(new AncientRootGenerator.Piece(manager, (ResourceLocation) Util.getRandom(FOSSILS, random), pos, blockRotation));
    }
