...
{
    private static final ResourceLocation[] FOSSILS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "bygone_fossil/bygone_fossil_1"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "bygone_fossil/bygone_fossil_2"),
            ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "bygone_fossil/bygone_fossil_3"), ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "bygone_fossil/bygone_fossil_4"),
