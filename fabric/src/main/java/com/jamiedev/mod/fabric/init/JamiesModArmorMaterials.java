...
public class JamiesModArmorMaterials
{
    ...
    }), 9, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.3F, () -> Ingredient.of(JamiesModItems.SCALE));
    ...
    private static Holder<ArmorMaterial> register(
        ...
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(ResourceLocation.tryParse(JamiesModFabric.MOD_ID + ":" + id)));
    ...
    private static Holder<ArmorMaterial> register(
        ...
        return Registry.registerForHolder(
                ...
                ResourceLocation.tryParse(JamiesModFabric.MOD_ID + ":" + id),
