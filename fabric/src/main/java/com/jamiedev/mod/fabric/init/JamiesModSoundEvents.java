...
{
    public static final ResourceLocation AMBIENT_ANCIENTFOREST_ADDITIONS = JamiesModFabric.getModId("ambient.underhang.additions");
    public static final ResourceLocation AMBIENT_AMBERDESERT_ADDITIONS = JamiesModFabric.getModId("ambient.amber_desert.additions");
    public static final ResourceLocation AMBIENT_PRIMORDIALOCEAN_ADDITIONS = JamiesModFabric.getModId("ambient.primordial_ocean.additions");
    public static final ResourceLocation MUSIC_ANCIENTFOREST_ADDITIONS = JamiesModFabric.getModId("music.bygone.underhang");
    public static final ResourceLocation MUSIC_PRIMORDIALOCEAN_ADDITIONS = JamiesModFabric.getModId("music.bygone.primordial_ocean");
    public static final ResourceLocation AMBIENT_SHELFHOLLOW_ADDITIONS = JamiesModFabric.getModId("ambient.shelfhollow.additions");
    public static final ResourceLocation ENTITY_BIGBEAK_AMBIENT = JamiesModFabric.getModId("entity.bigbeak.ambient");
    public static final ResourceLocation ENTITY_BIGBEAK_HURT = JamiesModFabric.getModId("entity.bigbeak.hurt");
    public static final ResourceLocation ENTITY_BIGBEAK_DEATH = JamiesModFabric.getModId("entity.bigbeak.death");
    public static final ResourceLocation ENTITY_BIGBEAK_JUMP = JamiesModFabric.getModId("entity.bigbeak.jump");
    public static final ResourceLocation ENTITY_BIGBEAK_STEP = JamiesModFabric.getModId("entity.bigbeak.step");
    public static final ResourceLocation ENTITY_BIGBEAK_STEP_WOOD = JamiesModFabric.getModId("entity.bigbeak.step_wood");
    public static final ResourceLocation ENTITY_BIGBEAK_GALLOP = JamiesModFabric.getModId("entity.bigbeak.gallop");

    public static final ResourceLocation ENTITY_MOOBOO_AMBIENT = JamiesModFabric.getModId("entity.mooboo.ambient");
    public static final ResourceLocation ENTITY_MOOBOO_HURT = JamiesModFabric.getModId("entity.mooboo.hurt");
    public static final ResourceLocation ENTITY_MOOBOO_DEATH = JamiesModFabric.getModId("entity.mooboo.death");

    public static final ResourceLocation ENTITY_FUNGUSPARENT_AMBIENT = JamiesModFabric.getModId("entity.fungus_parent.ambient");
    public static final ResourceLocation ENTITY_FUNGUSPARENT_BABY_AMBIENT = JamiesModFabric.getModId("entity.fungus_parent.ambient_baby");
    public static final ResourceLocation ENTITY_FUNGUSPARENT_HURT = JamiesModFabric.getModId("entity.fungus_parent.hurt");
    public static final ResourceLocation ENTITY_FUNGUSPARENT_DEATH = JamiesModFabric.getModId("entity.fungus_parent.death");
    ...
    private static SoundEvent register(String id) {
        return Registry.register(BuiltInRegistries.SOUND_EVENT, JamiesModFabric.getModId(id), SoundEvent.createVariableRangeEvent(JamiesModFabric.getModId(id)));
    }
