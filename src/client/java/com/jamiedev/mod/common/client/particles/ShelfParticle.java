...
public class ShelfParticle extends SpriteBillboardParticle {

    ShelfParticle(ClientWorld world, SpriteProvider spriteProvider, double x, double y, double z) {
    ...
    ShelfParticle(ClientWorld world, SpriteProvider spriteProvider, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
    ...
    public ShelfParticle(SporeBlossomAirFactory sporeBlossomAirFactory, ClientWorld clientWorld, SpriteProvider spriteProvider, double d, double e, double f, double v, double v1, double v2) {
