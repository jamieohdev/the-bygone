...
{
    public static RegistryEntry<ArmorMaterial> SCALE = register("scale", Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    ...
    private static RegistryEntry<ArmorMaterial> register(
        ...
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(Identifier.tryParse(JamiesModFabric.MOD_ID + ":" + id)));
    ...
    private static RegistryEntry<ArmorMaterial> register(
        ...
        return Registry.registerReference(
                ...
                Identifier.tryParse(JamiesModFabric.MOD_ID + ":" + id),
