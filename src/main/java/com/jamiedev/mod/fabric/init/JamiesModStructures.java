...
public class JamiesModStructures
{
    ...
    {
        ANCIENT_ROOTS = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID, "ancient_roots"), () -> AncientRootStructure.CODEC);
        BYGONE_FOSSIL = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID , "bygone_fossil"), () -> BygoneFossilStructure.CODEC);
        BYGONE_PORTAL = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID , "bygone_portal"), () -> BygonePortalStructure.CODEC);
        TEST_ROOTS = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID, "test_roots"), () -> TestRootStructure.CODEC);
        BLEMISH_RUINS = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID, "ruin"), () -> RuinStructure.CODEC);
        AMBER_RUINS = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID, "amber_ruins"), () -> AmberRuinsStructure.CODEC);
        BYGONE_MINESHAFT = Registry.register(Registries.STRUCTURE_TYPE, Identifier.of(JamiesModFabric.MOD_ID, "bygone_mineshaft"), () -> BygoneMineshaftStructure.CODEC);
    }
}
