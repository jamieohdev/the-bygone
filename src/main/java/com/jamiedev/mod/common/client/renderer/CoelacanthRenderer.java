...
public class CoelacanthRenderer extends MobRenderer<CoelacanthEntity, CoelacanthModel<CoelacanthEntity>> {
    private static final ResourceLocation TEXTURE = JamiesModFabric.getModId("textures/entity/coelacanth.png");
SalmonRenderer ref;
    ...
    public ResourceLocation getTexture(CoelacanthEntity coelacanthEntity) {
        return TEXTURE;
    }
   ...
   // protected float getAnimationProgress(CoelacanthEntity coelacanthEntity, float f) {
    ...
    protected void setupTransforms(CoelacanthEntity salmonEntity, PoseStack matrixStack, float f, float g, float h, float i) {
