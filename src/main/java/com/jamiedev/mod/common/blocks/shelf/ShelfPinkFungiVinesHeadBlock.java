...
public class ShelfPinkFungiVinesHeadBlock extends AbstractPlantStemBlock implements Fertilizable, ShelfVines {
    public static final MapCodec<ShelfPinkFungiVinesHeadBlock> CODEC = createCodec(ShelfPinkFungiVinesHeadBlock::new);
    private static final float GROW_CHANCE = 0.11F;

    public MapCodec<ShelfPinkFungiVinesHeadBlock> getCodec() {
        return CODEC;
    }

    public ShelfPinkFungiVinesHeadBlock(Settings settings) {
