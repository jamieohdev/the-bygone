...
{
    private static final ResourceLocation[] PORTAL = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(JamiesModFabric.MOD_ID, "bygone_portal/bygone_portal")};
