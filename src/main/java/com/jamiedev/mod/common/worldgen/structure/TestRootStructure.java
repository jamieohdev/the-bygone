...
public class TestRootStructure  extends Structure {
    ...
    public static final MapCodec<TestRootStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(TestRootStructure.configCodecBuilder(instance),
    ...
    public TestRootStructure(Structure.Config config,
    ...
    public StructureType<?> getType() {
        return JamiesModStructures.TEST_ROOTS; // Helps the game know how to turn this structure back to json to save to chunks
    }
}