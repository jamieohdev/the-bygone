...
public class PointedAmberClusterFeatureConfig implements FeatureConfig {
    public static final Codec<PointedAmberClusterFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), IntProvider.createValidatingCodec(0, 128).fieldOf("amber_block_layer_thickness").forGetter((config) -> {
