...
public class JamiesModBlocks {
    ...
    public static final Block COBBLED_BYSLATE_STAIRS = registerBlock("cobbled_byslate_stairs",
            new StairBlock(JamiesModBlocks.COBBLED_BYSLATE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block COBBLED_BYSLATE_SLAB = registerBlock("cobbled_byslate_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.COBBLED_BYSLATE).strength(2.0f)));

    public static final Block COBBLED_BYSLATE_WALL = registerBlock("cobbled_byslate_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.COBBLED_BYSLATE).strength(2.0f)));
    ...
    public static final Block CLAYSTONE_BRICKS_STAIRS = registerBlock("claystone_bricks_stairs",
            new StairBlock(JamiesModBlocks.CLAYSTONE_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block CLAYSTONE_BRICKS_SLAB = registerBlock("claystone_bricks_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.CLAYSTONE_BRICKS).strength(2.0f)));

    public static final Block CLAYSTONE_BRICKS_WALL = registerBlock("claystone_bricks_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.CLAYSTONE_BRICKS).strength(2.0f)));
...
// Start of the Primordial Ocean blockset
    ...
    public static final Block MALACHITE_STAIRS = registerBlock("malachite_stairs",
            new StairBlock(JamiesModBlocks.MALACHITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block MALACHITE_SLAB = registerBlock("malachite_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.MALACHITE).strength(2.0f)));

    public static final Block MALACHITE_WALL = registerBlock("malachite_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.MALACHITE).strength(2.0f)));
...
// Shelf Hollows blocksets
    ...
    public static final Block ORANGE_FUNGAL_STAIRS = registerBlock("orange_fungal_stairs",
            new StairBlock(JamiesModBlocks.ORANGE_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block ORANGE_FUNGAL_SLAB = registerBlock("orange_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.ORANGE_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block ORANGE_FUNGAL_WALL = registerBlock("orange_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.ORANGE_FUNGAL_BRICKS).strength(2.0f)));
    ...
    public static final Block PINK_FUNGAL_STAIRS = registerBlock("pink_fungal_stairs",
            new StairBlock(JamiesModBlocks.PINK_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block PINK_FUNGAL_SLAB = registerBlock("pink_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.PINK_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block PINK_FUNGAL_WALL = registerBlock("pink_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.PINK_FUNGAL_BRICKS).strength(2.0f)));
    ...
    public static final Block PURPLE_FUNGAL_STAIRS = registerBlock("purple_fungal_stairs",
            new StairBlock(JamiesModBlocks.PURPLE_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block PURPLE_FUNGAL_SLAB = registerBlock("purple_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.PURPLE_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block PURPLE_FUNGAL_WALL = registerBlock("purple_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(JamiesModBlocks.PURPLE_FUNGAL_BRICKS).strength(2.0f)));
