...
public class BGItems
{
    ...
    public static final Item ANCIENT_SIGN = registerItem("ancient_sign",
            new SignItem(new Item.Properties().stacksTo(16), BGBlocks.ANCIENT_SIGN, BGBlocks.ANCIENT_WALL_SIGN));

    public static final Item ANCIENT_HANGING_SIGN = registerItem("ancient_hanging_sign",
            new HangingSignItem(BGBlocks.ANCIENT_HANGING_SIGN, BGBlocks.ANCIENT_WALL_HANGING_SIGN, new Item.Properties().stacksTo(16)));
    ...
    public static final Item GOURD_DANGO = registerItem("glow_gourd_dango", new StandingAndWallBlockItem(BGBlocks.GOURD_DANGO, BGBlocks.GOURD_DANGO_WALL,
    ...
    public static final Item BIG_BEAK_SPAWN_EGG = registerItem("big_beak_spawn_egg", new SpawnEggItem(BGEntityTypes.BIG_BEAK, 0x85c70a, 0xffae00, new Item.Properties()));
    public static final Item COELACANTH_SPAWN_EGG = registerItem("coelacanth_spawn_egg", new SpawnEggItem(BGEntityTypes.COELACANTH, 0x266a78, 0x238349, new Item.Properties()));
    public static final Item COPPERBUG_SPAWN_EGG = registerItem("copperbug_spawn_egg", new SpawnEggItem(BGEntityTypes.COPPERBUG, 0x28e658, 0x25cba1, new Item.Properties()));

    public static final Item FUNGALPARENT_SPAWN_EGG = registerItem("fungal_parent_spawn_egg", new SpawnEggItem(BGEntityTypes.FUNGAL_PARENT, 0xf5f7e3, 0x3ed8fe, new Item.Properties()));


    public static final Item MOOBOO_SPAWN_EGG = registerItem("mooboo_spawn_egg", new SpawnEggItem(BGEntityTypes.MOOBOO, 0x5be3e8, 0xb2c7c8, new Item.Properties()));
    public static final Item PEST_SPAWN_EGG = registerItem("pest_spawn_egg", new SpawnEggItem(BGEntityTypes.PEST, 0x846B3C, 0x6C8031, new Item.Properties()));
    public static final Item SCUTTLE_SPAWN_EGG = registerItem("scuttle_spawn_egg", new SpawnEggItem(BGEntityTypes.SCUTTLE, 0x274772, 0xeab033, new Item.Properties()));
    public static final Item TRILOBITE_SPAWN_EGG = registerItem("trilobite_spawn_egg", new SpawnEggItem(BGEntityTypes.TRILOBITE, 0x233c56, 0x14a4aa, new Item.Properties()));
    ...
    public static final Item AMARANTH_SEEDS = registerItem("amaranth_seeds", new ItemNameBlockItem(BGBlocks.AMARANTH_CROP, new Item.Properties()));
    ...
    public static final Item PLAGA_SEEDS = registerItem("plaga_seeds", new ItemNameBlockItem(BGBlocks.PLAGA_CROP, new Item.Properties()));
    public static final Item PLAGA = registerItem("plaga", new StandingAndWallBlockItem(BGBlocks.PLAGA, BGBlocks.PLAGA_WALL,
            new Item.Properties(), Direction.DOWN));

    public static final Item CHANTRELLE_SEEDS = registerItem("chantrelle_seeds", new ItemNameBlockItem(BGBlocks.CHANTRELLE, new Item.Properties()));
    public static final Item CHANTRELLE = registerItem("chantrelle", new Item(new Item.Properties().food(AMARANTH_LOAF_COMP)));

    public static final Item ORANGE_FUNGI  = registerItem("orange_fungi_vines", new ItemNameBlockItem(BGBlocks.ORANGE_FUNGI_VINES, (new Item.Properties())));
    public static final Item PINK_FUNGI  = registerItem("pink_fungi_vines", new ItemNameBlockItem(BGBlocks.PINK_FUNGI_VINES, (new Item.Properties())));
    public static final Item PURPLE_FUNGI  = registerItem("purple_fungi_vines", new ItemNameBlockItem(BGBlocks.PURPLE_FUNGI_VINES, (new Item.Properties())));
