...
// .dimensions(0.6F, 2.9F).eyeHeight(2.55F).passengerAttachments(2.80625F).maxTrackingRange(8));
    ...
    public static final Supplier<EntityType<ScuttleEntity>> SCUTTLE = registerEntityType("scuttle", () ->
            EntityType.Builder.of(ScuttleEntity::new, MobCategory.WATER_CREATURE)
                    .sized(0.8F, 0.4F).build(""));    public static final Supplier<EntityType<GlareEntity>> GLARE = registerEntityType("glare", () ->
    ...
    public static final Supplier<EntityType<WispEntity>> WISP = registerEntityType("wisp", () ->
            EntityType.Builder.of(WispEntity::new, MobCategory.CREATURE)
                    ...
                    .clientTrackingRange(8)
                    .updateInterval(2)
                    .build(""));    public static final Supplier<EntityType<PestEntity>> PEST = registerEntityType("pest", () ->
