...
public class BGBlocks {
    ...
    public static BlockItem createBlockItem(String blockID, Block block){
        return Registry.register(BuiltInRegistries.ITEM, Bygone.id(blockID), new BlockItem(block, new Item.Properties().fireResistant()));
    }
    ...
    public static final Block POLISHED_BYSTONE_STAIRS = registerBlock("polished_bystone_stairs",
            new StairBlock(BGBlocks.POLISHED_BYSTONE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block POLISHED_BYSTONE_WALL = registerBlock("polished_bystone_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.POLISHED_BYSTONE).strength(2.0f)));
    ...
    public static final Block POLISHED_BYSLATE_STAIRS = registerBlock("polished_byslate_stairs",
            new StairBlock(BGBlocks.POLISHED_BYSLATE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block POLISHED_BYSLATE_WALL = registerBlock("polished_byslate_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.POLISHED_BYSLATE).strength(2.0f)));
    ...
    public static final Block POLISHED_BYSTONE_BRICK_STAIRS = registerBlock("polished_bystone_bricks_stairs",
            new StairBlock(BGBlocks.POLISHED_BYSTONE_BRICK.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block POLISHED_BYSTONE_BRICK_WALL = registerBlock("polished_bystone_bricks_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.POLISHED_BYSTONE_BRICK).strength(2.0f)));
    ...
    public static final Block POLISHED_BYSLATE_BRICK_STAIRS = registerBlock("polished_byslate_bricks_stairs",
            new StairBlock(BGBlocks.POLISHED_BYSLATE_BRICK.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block POLISHED_BYSLATE_BRICK_WALL = registerBlock("polished_byslate_bricks_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.POLISHED_BYSLATE_BRICK).strength(2.0f)));
    ...
    public static final Block  BYGONESLATE_IRON_ORE = registerBlock("byslate_iron_ore", new DropExperienceBlock(ConstantInt.of(0),
            BlockBehaviour.Properties.ofLegacyCopy(BYGONESTONE_IRON_ORE).mapColor(MapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE)));
    ...
    public static final Block BYGONESLATE_COAL_ORE = registerBlock("byslate_coal_ore", new DropExperienceBlock(ConstantInt.of(0),
            BlockBehaviour.Properties.ofLegacyCopy(BYGONESTONE_COAL_ORE).mapColor(MapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE)));
    ...
    public static final Block COBBLED_BYSTONE_STAIRS = registerBlock("cobbled_bystone_stairs",
            new StairBlock(BGBlocks.COBBLED_BYSTONE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));
    ...
    public static final Block COBBLED_BYSTONE_WALL = registerBlock("cobbled_bystone_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.COBBLED_BYSTONE).strength(2.0f)));
    ...
    public static final Block COBBLED_BYSLATE_STAIRS = registerBlock("cobbled_byslate_stairs",
            new StairBlock(BGBlocks.COBBLED_BYSLATE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block COBBLED_BYSLATE_SLAB = registerBlock("cobbled_byslate_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.COBBLED_BYSLATE).strength(2.0f)));

    public static final Block COBBLED_BYSLATE_WALL = registerBlock("cobbled_byslate_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.COBBLED_BYSLATE).strength(2.0f)));
    ...
    public static  final  Block TALL_GRASS = registerBlockWithoutBlockItem("tall_grass", new UpsidedownTallPlantBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).
    ...
    public static  final  Block SHORT_GRASS = registerBlock("under_grass", new UpsidedownShortPlantBlock(BlockBehaviour.Properties.of()
    ...
    public static final Block CLAYSTONE = registerBlock("claystone", new Block(BlockBehaviour.Properties.ofLegacyCopy(DIRT).strength(1.0F, 3.0F).sound(SoundType.PACKED_MUD)));
    public static final Block COARSE_CLAYSTONE = registerBlock("coarse_claystone", new Block(BlockBehaviour.Properties.ofLegacyCopy(DIRT).strength(1.0F, 3.0F).sound(SoundType.PACKED_MUD)));
    public static final Block CLAYSTONE_BRICKS = registerBlock("claystone_bricks", new Block(BlockBehaviour.Properties.ofLegacyCopy(DIRT).strength(1.0F, 3.0F).sound(SoundType.PACKED_MUD)));

    public static final Block CLAYSTONE_BRICKS_STAIRS = registerBlock("claystone_bricks_stairs",
            new StairBlock(BGBlocks.CLAYSTONE_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block CLAYSTONE_BRICKS_SLAB = registerBlock("claystone_bricks_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.CLAYSTONE_BRICKS).strength(2.0f)));

    public static final Block CLAYSTONE_BRICKS_WALL = registerBlock("claystone_bricks_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.CLAYSTONE_BRICKS).strength(2.0f)));
    ...
    public static final Block ANCIENT_SAPLING = createBlockWithItem("ancient_sapling", new AncientSaplingBlock(BGTreeGrowers.ANCIENT_TREE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)));
    ...
    public static final Block ANCIENT_STAIRS = registerBlock("ancient_stairs",
            new StairBlock(ANCIENT_PLANKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS).strength(2.0f)));
    ...
    public static final Block ANCIENT_WALL_SIGN = registerBlockWithoutBlockItem("ancient_wall_sign",
            new WallSignBlock(JamiesModWoodType.ANCIENT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN).strength(1.0f).dropsLike(BGBlocks.ANCIENT_SIGN).forceSolidOn()));
...
// Start of the Primordial Ocean blockset
    ...
    public static final Block BLUE_ALGAE = registerBlock("blue_algae", new BlueAlgueBlock((SimpleParticleType) BGParticleTypes.ALGAE_BLOOM, BlockBehaviour.Properties.of().mapColor(MapColor.GLOW_LICHEN)
    ...
    public static final Block MALACHITE_STAIRS = registerBlock("malachite_stairs",
            new StairBlock(BGBlocks.MALACHITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block MALACHITE_SLAB = registerBlock("malachite_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.MALACHITE).strength(2.0f)));

    public static final Block MALACHITE_WALL = registerBlock("malachite_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.MALACHITE).strength(2.0f)));
    ...
    public static final Block DEAD_ORANGE_CORAL_WALL_FAN = registerBlockWithoutBlockItem("dead_rugosa_coral_wall_fan", new BaseCoralWallFanBlock(
            BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).forceSolidOn().instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops()
                    .noCollission().instabreak().dropsLike(DEAD_ORANGE_CORAL_FAN)));
    public static final Block ORANGE_CORAL_WALL_FAN = registerBlockWithoutBlockItem("rugosa_coral_wall_fan", new CoralWallFanBlock(DEAD_ORANGE_CORAL_WALL_FAN,
            BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).noCollission().instabreak().sound(SoundType.WET_GRASS)
                    .dropsLike(ORANGE_CORAL_FAN).pushReaction(PushReaction.DESTROY)));
    ...
    public static final Block DEAD_BLUE_CORAL_WALL_FAN = registerBlockWithoutBlockItem("dead_tabulata_coral_wall_fan", new BaseCoralWallFanBlock(
            BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).forceSolidOn().instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops()
                    .noCollission().instabreak().dropsLike(DEAD_BLUE_CORAL_FAN)));
    public static final Block BLUE_CORAL_WALL_FAN = registerBlockWithoutBlockItem("tabulata_coral_wall_fan", new CoralWallFanBlock(DEAD_BLUE_CORAL_WALL_FAN,
            BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).noCollission().instabreak().sound(SoundType.WET_GRASS)
                    .dropsLike(BLUE_CORAL_FAN).pushReaction(PushReaction.DESTROY)));
...
// Start of Amber Desert blocksets!
    ...
    public static final Block POINTED_AMBER = registerBlock("pointed_amber", new PointedAmberBlock2(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).forceSolidOn()
...
// Shelf Hollows blocksets
    ...
    public static final Block ORANGE_FUNGAL_STAIRS = registerBlock("orange_fungal_stairs",
            new StairBlock(BGBlocks.ORANGE_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block ORANGE_FUNGAL_SLAB = registerBlock("orange_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.ORANGE_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block ORANGE_FUNGAL_WALL = registerBlock("orange_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.ORANGE_FUNGAL_BRICKS).strength(2.0f)));
    ...
    public static final Block PINK_FUNGAL_STAIRS = registerBlock("pink_fungal_stairs",
            new StairBlock(BGBlocks.PINK_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block PINK_FUNGAL_SLAB = registerBlock("pink_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.PINK_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block PINK_FUNGAL_WALL = registerBlock("pink_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.PINK_FUNGAL_BRICKS).strength(2.0f)));
    ...
    public static final Block PURPLE_FUNGAL_STAIRS = registerBlock("purple_fungal_stairs",
            new StairBlock(BGBlocks.PURPLE_FUNGAL_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_STAIRS).strength(2.0f)));

    public static final Block PURPLE_FUNGAL_SLAB = registerBlock("purple_fungal_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.PURPLE_FUNGAL_BRICKS).strength(2.0f)));

    public static final Block PURPLE_FUNGAL_WALL = registerBlock("purple_fungal_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(BGBlocks.PURPLE_FUNGAL_BRICKS).strength(2.0f)));
...
**/
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, Bygone.id( name), block);
    }


    private static <B extends Block> B registerBlockWithoutBlockItem(String name, B block) {
        return Registry.register(BuiltInRegistries.BLOCK, Bygone.id(name), block);
    }

    private static Item registerBlockItem(String name, Block block) {

        Item item = Registry.register(BuiltInRegistries.ITEM, Bygone.id( name),
