...
public class BGBlocks {
    ...
    public static final Supplier<Block> GOURD_VINE = registerBlockWithoutBlockItem("gourd_vine", () -> new GourdVineBlock(BlockBehaviour.Properties.of().replaceable().noCollission()
