    ...
    public static BehaviorControl<Mob> create(Function<LivingEntity, Float> speedModifier, int dist) {
        return BehaviorBuilder.create(
                p_258687_ -> p_258687_.group(
                        ...
                        .apply(p_258687_, (walk_target, look_target, attack_target, group_leader, nearest_visible_living_entities) -> (p_258694_, p_258695_, p_258696_) -> {
                            ...
                            if (optional.isPresent() && optional.get().contains(livingentity) && BehaviorUtils.isWithinAttackRange(p_258695_, livingentity, 1)) {
                                ...
                                walk_target.set(new WalkTarget(new EntityTracker(livingentity, false), speedModifier.apply(p_258695_), dist));
                            }
