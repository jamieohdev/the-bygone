...
public class JawsRenderer extends MobRenderer<JawsEntity, JawsEntityModel>
{
    ...
    private static final ResourceLocation TEXTURE = Bygone.id("textures/entity/jaws.png");
    private static final ResourceLocation EXPLOSION_BEAM_TEXTURE = Bygone.id("textures/entity/jaws_attack.png");
