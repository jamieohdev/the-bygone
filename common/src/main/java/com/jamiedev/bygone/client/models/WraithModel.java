...
//	private final ModelPart camera;
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(34, 1).addBox(-4.0F, -7.0F, -2.5F, 8.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.0F, -4.5F, 8.0F, 12.0F, 9.0F, new CubeDeformation(0.25F))
                .texOffs(30, 22).addBox(-3.0F, -7.0F, -4.5F, 6.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));

        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offset(6.0F, -3.0F, 1.0F));

        PartDefinition left_arm2 = left_arm.addOrReplaceChild("left_arm2", CubeListBuilder.create().texOffs(30, 38).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 45).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.125F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offset(-6.0F, -3.0F, 1.0F));

        PartDefinition right_arm2 = right_arm.addOrReplaceChild("right_arm2", CubeListBuilder.create().texOffs(30, 38).mirror().addBox(-2.0F, -2.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 45).mirror().addBox(-0.5F, -1.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.125F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
