...
public class CoelacanthModel<E extends Entity> extends HierarchicalModel<E> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition fish = partdefinition.addOrReplaceChild(
                "fish",
                CubeListBuilder.create(),
                PartPose.offset(0.0F, 27.0F, -6.0F)
        );

        PartDefinition midbody = partdefinition.addOrReplaceChild(
                "midbody",
                CubeListBuilder.create().texOffs(0, 0).addBox(
                                -4.0F, -7.0F, 4.0F, 8.0F, 12.0F, 11.0F,
        ...
        PartDefinition midfin = midbody.addOrReplaceChild(
                "midfin",
                CubeListBuilder.create(),
                PartPose.offset(3.0F, 3.0F, -2.0F)
        );

        PartDefinition cube_r1 = midfin.addOrReplaceChild(
                "cube_r1",
                CubeListBuilder.create()
                        .texOffs(8, 41)
                        .mirror()
                        .addBox(-6.7373F, -5.0F, -1.6756F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F))
                        .mirror(false),
                PartPose.offsetAndRotation(-6.0F, 0.0F, 9.0F, 0.0F, 0.7418F, 0.0F)
        );

        PartDefinition cube_r2 = midfin.addOrReplaceChild(
                "cube_r2",
                CubeListBuilder.create()
                        .texOffs(8, 41)
                        .addBox(-0.2627F, -5.0F, -1.6756F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.0F, 9.0F, 0.0F, -0.7418F, 0.0F)
        );
        ...
        PartDefinition cube_r4 = head.addOrReplaceChild(
                "cube_r4", CubeListBuilder.create().texOffs(0, 23)
        ...
        PartDefinition lowerbody = partdefinition.addOrReplaceChild(
                "lowerbody",
                CubeListBuilder.create()
                        .texOffs(28, 23)
                        .addBox(-3.0F, -10.0F, 3.0F, 6.0F, 10.0F, 7.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 0)
                        .addBox(0.0F, -14.0F, 4.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 19)
                        .addBox(0.0F, 0.0F, 7.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 24.0F, 7.0F)
        );

        PartDefinition tail = lowerbody.addOrReplaceChild(
                "tail",
                CubeListBuilder.create()
                        .texOffs(38, 0)
                        .addBox(-1.0F, -9.0F, 0.0F, 2.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition tail = lowerbody.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(38, 0)
                        .addBox(-1.0F, -9.0F, 11.0F, 2.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition cube_r3 = tail.addOrReplaceChild(
                "cube_r3",
                CubeListBuilder.create()
                        .texOffs(28, 32)
                        .addBox(0.0F, -8.0F, -1.0F, 0.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -4.5F, 4.0F, -0.7854F, 0.0F, 0.0F) // 14 -> 3
        );
    ...
    public void setupAnim(E entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.lowerbody.yRot = -f * 0.25F * Mth.sin(g * 0.4F * animationProgress);
        this.tail.yRot = -f * 0.4F * Mth.sin(g * 0.4F * animationProgress);
