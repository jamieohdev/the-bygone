...
public class NectaurAnimations {
	public static final AnimationDefinition NECTAUR_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(13.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("frill3", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-3.182F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("frill2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 1.0607F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("frill4", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -1.0607F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.8925F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();

	public static final AnimationDefinition idle_look = AnimationDefinition.Builder.withLength(2.25F)
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(-2.5F, -2.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.3333F, KeyframeAnimations.degreeVec(10.3372F, 14.8052F, 2.2279F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.625F, KeyframeAnimations.degreeVec(10.3372F, 14.8052F, 2.2279F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.8333F, KeyframeAnimations.degreeVec(30.729F, -47.6746F, -16.5753F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.7083F, KeyframeAnimations.degreeVec(30.729F, -47.6746F, -16.5753F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.9583F, KeyframeAnimations.degreeVec(-2.5F, 2.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.625F, KeyframeAnimations.degreeVec(0.0F, -7.69F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition idle_sneeze = AnimationDefinition.Builder.withLength(2.5F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(1.2917F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.1F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("frill2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.3333F, KeyframeAnimations.degreeVec(0.0F, -39.09F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.5833F, KeyframeAnimations.degreeVec(0.0F, -39.09F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.9167F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("frill4", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.9583F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(30.36F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
